...
val KB_EN_CUSTOM_012_SHIFTED_ALT =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_EN_CUSTOM_012: KeyboardDefinition =
    KeyboardDefinition(
        title = "english custom keyboard - 012",
        modes =
            KeyboardDefinitionModes(
                main = KB_EN_CUSTOM_012_MAIN,
                shifted = KB_EN_CUSTOM_012_SHIFTED,
                shiftedalt = KB_EN_CUSTOM_012_SHIFTED_ALT,
